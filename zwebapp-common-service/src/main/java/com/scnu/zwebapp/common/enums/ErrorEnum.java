...
public enum ErrorEnum implements IErrorEnum {
	...
	/**流水记录类型不能为收入  **/
	ERRCODE_0103("0103", "流水记录类型不能为收入"),
	
	/** 原账户和目标账户账户类型有误，无法转账 **/
	ERRCODE_0104("0104", "原账户和目标账户账户类型有误，无法转账"),
	
	/** 只有自由账户才能记为收入流水 **/
	ERRCODE_0105("0105", "只有自由账户才能记为收入流水"),

	/** 该账户不能被支出 **/
	ERRCODE_0106("0106", "该账户不能被支出"),
	
	/** 该账户不能被转账 **/
	ERRCODE_0107("0107", "该账户不能被转账"),
	
	/** 原账户和目标账户必须有一个自由账户 **/
	ERRCODE_0108("0108", "原账户和目标账户必须有一个自由账户"),
	
	/** 暂不支持定向账户转出 **/
	ERRCODE_0109("0109", "暂不支持定向账户转出"),
